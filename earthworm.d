...
#   module ids and message types are sacred to earthworm.d
...
#--------------------------------------------------------------------------
 ...
 Ring   STATUS          1000    # public waveform data
...
# Do not put FLAG_RING in starstop*.d  This is a hidden ring used for termination flags.
 Ring   FLAG_RING        2000    # a private ring for Startstop 7.5 and later to use
                                 # for flags. If this doesnt exist, startstop will 
                                 # create the ring automatically at key 9999
                                 # If you run multiple startstops, youll need to change
...
# 
# This list is in alphabetical order but doesnt need to be. Go ahead and
...
#--------------------------------------------------------------------------
 ...
 Module   MOD_IMPORT_POHV       156
 Module   MOD_IMPORT_SSN        157
 Module   MOD_CONT_TRIG_ORI     158
 Module   MOD_TRIG2DISK_CONT    159
 Module   MOD_TRIG2DISK_ORI     160
 Module   MOD_WSERV_PRIVATE     162
 Module   MOD_WSERV_PUBLIC      163
 Module   MOD_WSERV_SCN         164
 Module   MOD_EXPORT_OSV        165
 Module   MOD_EXPORT_ACK_OSV    166
 Module   MOD_EXPORT_ACK2LNX    167
...
#  VALID numbers are:
#
# 100-255 Message types 100-255 are defined in each installations  
